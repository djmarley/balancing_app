...
def init_db():
    ...
    cursor = conn.cursor()
     ...
     # Drop all tables
    cursor.execute('''
        DROP TABLE IF EXISTS ez_teller_balance;
    ''')
    cursor.execute('''
        DROP TABLE IF EXISTS branch_limits;
    ''')
    cursor.execute('''
        DROP TABLE IF EXISTS mismatch_actions;                                                         
    ''')
    cursor.execute('''
    ...
    gl_data = [
        (1000001001, '001', '001-branch 1', 5000, '2025-02-13'),
        (1000002001, '001', '001-branch 1', 3000, '2025-02-13'),
        (1000003001, '001', '001-branch 1', 4000, '2025-02-13'),        
        (1000001002, '002', '002-branch 2', 5000, '2025-02-13'),
        (1000002002, '002', '002-branch 2', 1000, '2025-02-13'),
        (1000003002, '002', '002-branch 2', 500000,  '2025-02-13'),
        (1000011002, '002', '002-branch 2', 194,   '2025-02-13'),
        ...
        (1000001001, '001', '001-branch 1', 5000, '2025-02-16'),
        (1000002001, '001', '001-branch 1', 3000, '2025-02-16'),
        (1000001002, '002', '002-branch 2', 5000, '2025-02-16'),
        (1000002002, '002', '002-branch 2', 1000, '2025-02-16'),
        (1000003002, '002', '002-branch 2', 500,  '2025-02-16'),
        (1000011002, '002', '002-branch 2', 94,   '2025-02-16')
    ]
    cursor.executemany('''
        INSERT INTO gl_balance (account, cost_center, branch_name, balance, date)
        VALUES (?, ?, ?, ?, ?)
    ''', gl_data)
    ...
    cursor.executemany('''
        INSERT INTO ez_teller_balance (account, cost_center, branch_name, balance, date)
        VALUES (?, ?, ?, ?, ?)
    ''', ez_data)
